# Mam-Unet
This code is directly related to our manuscript submitted to the Signal,image and video processed. We encourage readers to cite the manuscript when using this code and welcome submissions to Pattern Analysis and Applications.
